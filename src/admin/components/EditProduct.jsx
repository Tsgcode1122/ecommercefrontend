...
const EditProduct = () => {
  ...
  const { updateProduct, products, uploadImage, deleteImage } =
    useProductContext();
  ...
  const idToBack = singleProductEdit._id;
  useEffect(() => {
    if (singleProductEdit) {
      ...
      setVariants(singleProductEdit.variants || []);
    }
  }, [id, products, form]);
  ...
  const onFinish = (values) => {
    ...
    updateProduct(id, { ...values, variants, images: imageUrls });
